...
class THWCFD_Admin {
	...
	private function enqueue_styles($suffix) {
		...
		wp_enqueue_style('checkout-field-by-emon-admin-custom', THWCFD_ASSETS_URL_ADMIN . 'css/custom-admin.css', array( 'thwcfd-admin-style' ), $this->version);
	}
	...
	public function admin_menu() {
		...
		$this->screen_id = add_submenu_page('woocommerce', __('Checkout Field by Emon', 'woo-checkout-field-editor-pro'), __('Checkout Field by Emon', 'woo-checkout-field-editor-pro'), $capability, 'checkout_form_designer', array($this, 'output_settings'));
	...
	public function output_settings(){
		echo '<div class="wrap">';
		echo '<div class="wc-cfm-wrap thwcfd-wrap">';
		
		// Custom Premium Header
		?>
		<div class="wc-cfm-header">
			<div class="wc-cfm-branding">
				<div class="wc-cfm-logo">⚙️</div>
				<div>
					<h1>Checkout Field by Emon</h1>
					<p class="description"><?php esc_html_e( 'Dynamically manage and customize your WooCommerce checkout fields. Created by Emon.', 'woo-checkout-field-editor-pro' ); ?></p>
				</div>
			</div>
		</div>
		<?php
